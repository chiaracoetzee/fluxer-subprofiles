...
export type PersonaID = Brand<bigint, 'PersonaID'>;
...
export function createPersonaID<T extends bigint>(id: T extends BrandedValue ? never : T): PersonaID {
	return brand<T, 'PersonaID'>(id);
}

...
use crate::{
    api::{
        ...
        types::{
            ...
            ServerListButtonsUpdateRequest, SsoConfigUpdateRequest, VOICE_NS_MAX_GUILD_OVERRIDES,
            VoiceE2eeScope, VoiceNoiseSuppressionConfigUpdateRequest, VoiceNoiseSuppressionGuildOverride,
        },
    },
    config::AdminConfig,
    middleware::{
    ...
    InstanceConfigUpdateRequest {
        app_public: Some(AppPublicConfigUpdateRequest {
            branding: Some(AppBrandingConfigUpdateRequest {
                ...
                desktop_app_prompt_enabled: Some(form.bool_value("app_desktop_app_prompt_enabled")),
            }),
